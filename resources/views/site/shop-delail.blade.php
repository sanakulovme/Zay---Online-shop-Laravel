                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="h3 py-2">{{ $product->pricing }}</p>
                            <p class="py-2">
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col d-grid">
                                        <button type="button" onclick='addCard({{ auth()->user()->id }}, {{ $product->id }})' class="btn btn-success btn-lg" name="submit" value="addtocard">Add To Cart</button>
                                    </div>
                                </div>
                            </form>
